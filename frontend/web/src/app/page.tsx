          ...
          <div className="grid items-start gap-10 md:grid-cols-2">
            <div className="space-y-6">
              ...
              <p className="max-w-xl text-[15px] leading-7 text-[color:var(--ink-dim)]">
                EMWaver treats your phone and PC as part of the device. You iterate in
                scripts (with real UI) while the firmware stays stable.
              </p>
              ...
              <div className="flex flex-wrap items-center gap-3">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center justify-center rounded-xl border border-[color:var(--line)] bg-transparent px-5 py-3 text-sm font-semibold text-[color:var(--ink-dim)] hover:text-[color:var(--ink)]"
                >
                  Download releases
                </a>
              </div>
              ...
              <div className="grid max-w-xl grid-cols-3 gap-3 pt-2">
                <div className="rounded-xl border border-[color:var(--line)] bg-[color:var(--surface)] p-4">
                  <div className="text-xs text-[color:var(--ink-dim)]">Transport</div>
                  <div className="pt-1 text-sm font-semibold text-[color:var(--ink)]">USB MIDI SysEx</div>
                </div>
                <div className="rounded-xl border border-[color:var(--line)] bg-[color:var(--surface)] p-4">
                  <div className="text-xs text-[color:var(--ink-dim)]">Frames</div>
                  <div className="pt-1 text-sm font-semibold text-[color:var(--ink)]">Fixed 64 bytes</div>
                </div>
                <div className="rounded-xl border border-[color:var(--line)] bg-[color:var(--surface)] p-4">
                  <div className="text-xs text-[color:var(--ink-dim)]">Workflow</div>
                  <div className="pt-1 text-sm font-semibold text-[color:var(--ink)]">Run .emw scripts</div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid gap-4 md:grid-cols-3">
                ...
                <div className="rounded-2xl border border-[color:var(--line)] bg-[color:var(--surface)] p-4">
                  ...
                  <div className="pt-2 text-sm text-[color:var(--ink-dim)]">
                    STM32 only. One firmware binary.
                  </div>
                </div>
              </div>
            </div>
