          ...
          <div className="mt-6 rounded-2xl border border-[color:var(--line)] bg-[color:var(--surface)] p-5">
            ...
            <div className="mt-4">
              <button
                ...
                className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-[color:var(--ink)] px-4 py-2 text-sm font-semibold text-[color:var(--paper)] hover:opacity-95 disabled:opacity-50"
              >
                <span aria-hidden className="inline-flex h-5 w-5 items-center justify-center rounded bg-white/10">
                  G
                </span>
            ...
            <div className="mt-4 text-xs text-[color:var(--ink-dim)]">
              Redirect after sign-in: <span className="font-mono">{redirectTo}</span>
            </div>
          </div>
        </div>
      </main>
