...
The current local starting point for EMWaver Shield is a mirrored catalog entry plus external design links.
...
The repo does not yet contain committed local EDA or fabrication exports for the shield. Right now the external design links are still the working design-source references.
