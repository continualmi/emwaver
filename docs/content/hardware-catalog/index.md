...
- [Hardware Catalog](hardware.html)

## Current Gen Devices

<div class="emw-device-grid">
  <a class="emw-device-card" href="device.html?id=emwaver" target="_blank" rel="noopener">
  ...
  <a class="emw-device-card" href="device.html?id=ISM_WAVER" target="_blank" rel="noopener">
  ...
  <a class="emw-device-card" href="device.html?id=INFRARED_WAVER" target="_blank" rel="noopener">
    <img src="../INFRARED_WAVER.jpg" alt="Infrared Waver" class="emw-device-image" />
    <div class="emw-device-title">Infrared Waver</div>
    <div class="emw-device-subtitle">STM32F042</div>
  </a>
  <a class="emw-device-card" href="device.html?id=GPIO_WAVER" target="_blank" rel="noopener">
    <img src="../GPIO_WAVER.jpg" alt="GPIO Waver" class="emw-device-image" />
    <div class="emw-device-title">GPIO Waver</div>
    <div class="emw-device-subtitle">STM32F042</div>
  </a>
  <a class="emw-device-card" href="device.html?id=EMWAVER_DIY" target="_blank" rel="noopener">
  ...
  <a class="emw-device-card" href="device.html?id=EMWAVER_SHIELD" target="_blank" rel="noopener">
    <img src="../EMWAVER_SHIELD.jpg" alt="EMWaver Shield" class="emw-device-image" />
    <div class="emw-device-title">EMWaver Shield</div>
    <div class="emw-device-subtitle">Module</div>
  </a>
  <a class="emw-device-card" href="device.html?id=RFID_WAVER" target="_blank" rel="noopener">
