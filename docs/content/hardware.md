...
The EMWaver board combines the ESP32-S3 with dedicated RF and USB subsystems so you can prototype wireless workflows without stacking shields or breakout boards. This page highlights each hardware block and how it supports Wavelet-driven applications.
...
Pair these hardware capabilities with Wavelets and the EMWaver DSL to script RF experiments or USB automation without designing a custom PCB.
