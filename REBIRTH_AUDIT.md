...
| Native remote-control scope | `REBIRTH.md`, `REBIRTH-050`, `LAUNCH_MVP.md` | same-machine localhost gateway control is now the core posture; hosted macOS/Windows remote control remains to audit/remove from the core path |
