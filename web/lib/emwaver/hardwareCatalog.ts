...
import { PUBLIC_DIR } from "@/lib/emwaver/repoPaths";
...
const PUBLIC_HARDWARE_REPO_URL = "https://github.com/continualmi/emwaver";

const PUBLIC_HARDWARE_FOLDERS: Record<string, string> = {
  EMWAVER_DIY: "emwaver-core",
  EMWAVER_DIY_V1: "emwaver-carrier",
  EMWAVER_SHIELD: "emwaver-shield",
  RFID_WAVER: "rfid-waver",
  emwaver: "emwaver-link",
  "emwaver-v2": "emwaver-air",
  ISM_WAVER: "ism-waver",
  GPIO_WAVER: "gpio-waver",
  INFRARED_WAVER: "infrared-waver",
};
...
function parseManifest(slug: string): HardwareDevice {
  ...
  return {
    ...
    githubUrl,
    publicHardwareUrl: PUBLIC_HARDWARE_FOLDERS[slug]
      ? `${PUBLIC_HARDWARE_REPO_URL}/tree/main/hardware/${PUBLIC_HARDWARE_FOLDERS[slug]}`
      : null,
  };
}
