...
export default function HomePage() {
  return (
    <div className="min-h-dvh overflow-hidden">
      ...
      <main>
        <section className="relative min-h-[calc(100svh-74px)] px-5">
          <div className="absolute inset-0 -z-10">
            ...
            />
            <div className="absolute inset-0 bg-[linear-gradient(to_bottom,rgba(7,10,18,0.34),rgba(7,10,18,0.68)_70%,rgba(7,10,18,0.9))]" />
          </div>

          <div className="mx-auto flex min-h-[calc(100svh-74px)] max-w-6xl flex-col justify-center pb-16 pt-14">
