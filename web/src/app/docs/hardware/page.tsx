          ...
          >
              ...
              <div
                className={`rounded-full px-3 py-1 text-xs font-semibold ${
                  board.status === "Available" || board.status === "Supported"
                    ? "bg-[color:var(--aqua-tint-2)] text-[color:var(--aqua)]"
            ...
            {board.repo ? (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="mt-3 inline-flex items-center gap-2 rounded-lg border border-[color:var(--line)] bg-[color:var(--surface-3)] px-4 py-2 text-sm font-medium text-[color:var(--ink)] no-underline hover:bg-[color:var(--surface-2)]"
              >
