...
export function NewsMobileNav() {
  ...
  return (
    <details className="rounded-2xl border border-[color:var(--line)] bg-[color:var(--glass)] p-3 backdrop-blur">
      ...
      <div className="mt-3 grid gap-1">
        <a
          ...
          className="rounded-xl px-3 py-2 text-sm text-[color:var(--ink-dim)] hover:bg-[color:var(--surface)] hover:text-[color:var(--ink)]"
        >
