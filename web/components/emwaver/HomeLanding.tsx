...
const PILLARS: Pillar[] = [
  {
    ...
    body: "Grab a supported ESP32, ESP8266, or STM32 build, open the native app, and you are running local scripts on real hardware — no accounts, no cloud, no toolchain setup to fight first.",
    href: "/build",
    cta: "Open Build",
    image: "/landing1.jpeg",
    accent: "var(--aqua)",
  ...
  },
  {
    ...
    headline: "ESP32, ESP8266, STM32, and EMWaver modules.",
    body: "EMWaver supports a growing catalog of open boards — from ESP32-family and ESP8266 dev boards to purpose-built EMWaver modules — each with platform-managed firmware so the workflow stays script-first.",
    href: "/build",
    cta: "See the devices",
    image: "/EMWAVER.png",
    accent: "var(--aqua)",
...
const gettingStarted = [
  {
    ...
    body: "Start with an ESP32-family board (ESP32, ESP32-S2, or ESP32-S3), an ESP8266 board, or an EMWaver STM32 build from the catalog.",
    href: "/build",
    cta: "Open Build",
  },
  {
