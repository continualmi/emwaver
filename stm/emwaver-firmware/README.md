...
- `Drivers/` - CubeMX-generated HAL and CMSIS drivers (ignored in git; regenerated by STM32CubeMX)
- `Middlewares/` - CubeMX-generated middleware libraries (ignored in git; regenerated by STM32CubeMX)
