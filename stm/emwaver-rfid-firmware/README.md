# EMWaver STM32 RFID Firmware

This directory contains the STM32F042G6UX RFID firmware implementation using STM32CubeIDE.
...
- `emwaver-rfid-firmware.ioc` - STM32CubeMX project file
- `STM32F042G6UX_FLASH.ld` - Linker script

## Building

Open `emwaver-rfid-firmware.ioc` in STM32CubeIDE and build from there.
...
```bash
bash stm/emwaver-rfid-firmware/build_android_asset.sh
```
