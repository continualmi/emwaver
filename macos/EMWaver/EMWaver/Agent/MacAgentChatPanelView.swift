...
struct MacAgentChatPanelView: View {
    @ObservedObject var viewModel: MacAgentChatViewModel
...
private struct MessageRow: View {
    let message: MacAgentChatViewModel.Message
...
#Preview {
    // Note: requires AuthenticationManager; omit preview wiring.
    Text("Agent Chat")
}
