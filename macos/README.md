...
- The setup surface can query the ESP32-S3 binary Wi-Fi status opcode over USB/BLE and reports provisioned, station online/offline, reconnecting, and authenticated state for local diagnostics.
