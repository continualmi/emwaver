...
- The USB/BLE local setup surface can also reset only the ESP32 Wi-Fi pairing secret while keeping the existing SSID/password/hostname on the board, updating the matching local macOS pairing record when a hostname is provided.
