...
- Wi-Fi WebSocket authentication now verifies an HMAC-SHA256 response over a client nonce using the locally provisioned pairing secret. The raw pairing secret is not sent over the Wi-Fi socket.
