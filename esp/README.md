...
- Wi-Fi retransmit stream lanes now fill the same firmware circular RX buffer as USB retransmit data and return Wi-Fi `BS` buffer-status frames over the WebSocket with reserved envelope sequence `0`.
