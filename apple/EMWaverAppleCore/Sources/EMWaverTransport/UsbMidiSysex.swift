...
public enum UsbMidiSysex {
    ...
    public static func encodeSuperframe(_ superframe: Data) -> Data? {
    ...
    public static func decodeSysexToSuperframe(_ sysex: Data) -> Data? {
        // Fixed size: 1 + 1 + 3 + 42 + 1 = 48.
...
public struct UsbMidiSysexAccumulator {
