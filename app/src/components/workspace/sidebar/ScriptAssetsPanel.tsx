...
import { SCRIPT_ASSET_SCRIPTS, SCRIPT_BOOTSTRAP_FILENAME, iconLabelForPath } from "../workspaceUtils";
...
export default function ScriptAssetsPanel({ isCollapsed, onToggleCollapsed, onOpenAsset }: ScriptAssetsPanelProps) {
  const entries = useMemo(() => [SCRIPT_BOOTSTRAP_FILENAME, ...SCRIPT_ASSET_SCRIPTS], []);
