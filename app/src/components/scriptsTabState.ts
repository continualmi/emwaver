...
const STATE_FILE_NAME = "scripts-tabs.json";
...
export async function readScriptsTabState(rootDir: string | null): Promise<WorkspaceTabState | null> {
  if (!rootDir) {
    return null;
  }
...
export async function writeScriptsTabState(
  rootDir: string | null,
  openFiles: string[],
  active: string | null,
): Promise<void> {
