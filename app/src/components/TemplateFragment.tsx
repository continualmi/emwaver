...
export default function TemplateFragment() {
  ...
  const runExample = useCallback(async () => {
    if (!status.connected) {
      setResultText("Not connected. Connect via the EMWaver page (MIDI) first, then come back.");
      return;
    }
        ...
        <section className="min-h-0 rounded-xl border border-slate-900 bg-slate-950/60 p-4">
          ...
          <div className="mt-4">
            ...
            <div className="mt-2 text-xs text-slate-500">
              Connect/disconnect in the EMWaver page (MIDI). This Template view only demonstrates simple calls once connected.
            </div>
          </div>
