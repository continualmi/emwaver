...
Use EMWaver apps for normal operation. This page is for identifying, assembling,
and bringing up the shield hardware.

## Visual Identification

Photos show a long black shield with two dense through-hole header rows,
...
- [render](catalog/images/EMWAVER_SHIELD.png)
...
| [PickAndPlace_PCB_EMWAVER_SHIELD_2026-03-26.csv](PickAndPlace_PCB_EMWAVER_SHIELD_2026-03-26.csv) | assembly placement file |

This export set currently includes the schematic, PCB review PDF, BOM, and
pick-and-place file. Add the matching Gerber archive before ordering bare PCBs.

Rough historical estimate: 5 units for about 32 USD.
...
1. Confirm the Gerber archive matches this board revision.
2. Upload the Gerber archive.
