...
required_paths=(
  ...
  "usr/share/emwaver/default-scripts/emw-kernel.js"
  "usr/share/emwaver/default-scripts/cc1101.js"
...
grep -q 'EMWAVER_DEFAULT_SCRIPTS_DIR=/usr/share/emwaver/default-scripts' "${work_dir}/deb-root/usr/bin/emwaver-linux-app"
grep -q 'EMWAVER_FIRMWARE_DIR=/usr/share/emwaver/firmware' "${work_dir}/deb-root/usr/bin/emwaver-linux-app"
grep -q 'EMWAVER_ESP_HELPER_SOURCE=/usr/share/emwaver/tools/emwaver_esp_helper.py' "${work_dir}/deb-root/usr/bin/emwaver-linux-app"
