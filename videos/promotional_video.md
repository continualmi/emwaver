...
| `clip_028_bluepill_connected_as_emwaver_device.MOV` | `TBD` | `pending` | Show an STM32F103 BluePill running as part of EMWaver: connect it, surface the normal EMWaver runtime in-app, and hold long enough that viewers clearly understand this is not limited to only dedicated EMWaver-branded hardware. |
